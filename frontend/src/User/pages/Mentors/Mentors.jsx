...
import { FaLinkedin, FaTwitter } from 'react-icons/fa'; // Importing icons
            ...
            <Reorder.Item key={mentor.id} value={mentor} className="cursor-pointer">
              ...
              >
                ...
                <div className="flex justify-center space-x-4">
                  <a href={mentor.linkedin} target="_blank" rel="noopener noreferrer" className="text-blue-400 hover:text-blue-500 flex items-center">
                    <FaLinkedin className="mr-1" />
                  </a>
                  <a href={mentor.twitter} target="_blank" rel="noopener noreferrer" className="text-blue-400 hover:text-blue-500 flex items-center">
